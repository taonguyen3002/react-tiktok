...
export const IconInbox = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconPlus = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconHome = ({
    ...
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path fillRule="evenodd" clipRule="evenodd" d={d[0]}></path>
    </svg>
);
// icon friend arrow
...
export const IconFriendGroup = ({
    ...
    >
        <path fillRule="evenodd" clipRule="evenodd" d={d[0]}></path>
        <path fillRule="evenodd" clipRule="evenodd" d={d[1]}></path>
        <path fillRule="evenodd" clipRule="evenodd" d={d[2]}></path>
...
export const IconCompass = ({
    ...
    className,
    d = [
        'M24 37.4a13.4 13.4 0 1 0 0-26.8 13.4 13.4 0 0 0 0 26.8ZM40.5 24a16.5 16.5 0 1 1-33 0 16.5 16.5 0 0 1 33 0Z',
        'M27.13 27.18 19 32.1a.6.6 0 0 1-.9-.63l1.84-9.33a2 2 0 0 1 .92-1.32L29 15.9a.6.6 0 0 1 .9.63l-1.84 9.33a2 2 0 0 1-.93 1.32Zm-5.04-.45 3.11-1.89.7-3.57-3.1 1.89-.7 3.57Z',
    ],
}) => (
...
export const IconRecord = ({
    ...
    >
        <path fillRule="evenodd" clipRule="evenodd" d={d[0]}></path>
        <path fillRule="evenodd" clipRule="evenodd" d={d[1]} fill={pathFill}></path>
        <path fillRule="evenodd" clipRule="evenodd" d={d[2]}></path>
        <path fillRule="evenodd" clipRule="evenodd" d={d[3]}></path>
    </svg>
);
...
export const iconActivePath = {
    ...
    compass: {
        pathFirst:
            'M24 40.5a16.5 16.5 0 1 0 0-33 16.5 16.5 0 0 0 0 33Zm4.43-14.54c-.12.6-.49 1.12-1.01 1.44l-8.88 5.37a.65.65 0 0 1-.98-.69l2.01-10.18c.12-.6.49-1.12 1.01-1.44l8.88-5.37a.65.65 0 0 1 .98.69l-2.01 10.18Z',
        pathSecond: 'm21.92 26.89 3.4-2.05.76-3.9-3.4 2.06-.76 3.89Z',
    },
    friendGroup: {
        pathFirst:
            'M25.5 17C25.5 21.1421 22.1421 24.5 18 24.5C13.8579 24.5 10.5 21.1421 10.5 17C10.5 12.8579 13.8579 9.5 18 9.5C22.1421 9.5 25.5 12.8579 25.5 17Z',
        pathSecond:
            'M7.10396 34.7906C8.78769 30.2189 12.8204 27 18.0009 27C23.1818 27 27.2107 30.2213 28.8958 34.7898C29.3075 35.906 28.6141 37 27.5 37H8.5C7.38629 37 6.69289 35.9067 7.10396 34.7906Z',
        pathThird:
            'M40.6308 37H32C31.2264 34.1633 30.0098 31.5927 28.144 29.7682C29.5384 28.9406 31.1829 28.5 33 28.5C37.239 28.5 40.536 30.8992 41.9148 35.0108C42.2516 36.0154 41.5423 37 40.6308 37Z',
        pathFour:
            'M33 26.5C36.0376 26.5 38.5 24.0376 38.5 21C38.5 17.9624 36.0376 15.5 33 15.5C29.9624 15.5 27.5 17.9624 27.5 21C27.5 24.0376 29.9624 26.5 33 26.5Z',
    },
    record: {
        pathFirst:
            'M6.5 17.5714C6.5 14.7292 8.86029 12.5 11.6782 12.5H27.8621C30.6799 12.5 33.0402 14.7292 33.0402 17.5714V18.6843L36.745 15.9435C37.6399 15.2815 38.8324 15.1731 39.8318 15.6537C40.8365 16.1369 41.5 17.1486 41.5 18.2857V29.7143C41.5 30.8514 40.8365 31.8631 39.8318 32.3463C38.8324 32.8269 37.6399 32.7185 36.745 32.0565L33.0402 29.3158V30.4286C33.0402 33.2708 30.6799 35.5 27.8621 35.5H11.6782C8.86029 35.5 6.5 33.2708 6.5 30.4286V17.5714Z',
        pathSecond:
            'M23.25 23.134C23.9167 23.5189 23.9167 24.4811 23.25 24.866L17.25 28.3301C16.5833 28.715 15.75 28.2339 15.75 27.4641L15.75 20.5359C15.75 19.7661 16.5833 19.285 17.25 19.6699L23.25 23.134Z',
    },
};
